...
function marcarVersao(){
 ...
 p.id='versaoAgenda';
 p.textContent='Agenda v114 \u00b7 14.09.2026';
 alvo.appendChild(p);
}
...
montarBotaoMenu();
montarVoltaPortal();
setTimeout(montarBlocosRecolhiveis,600);
vigiarTema();
...
setTimeout(montarBlocosRecolhiveis,1300);
setTimeout(montarBlocosRecolhiveis,2200);
